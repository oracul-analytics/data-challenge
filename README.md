...
Три независимых сэндбокса под разные типы тестовых для дата инженера. Все решения держим в отдельных модулях c DDD/hex-структурой, воспроизводимость через `make`, Docker и общий оркестратор Nx.
